...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        ...
        <formula>IF(ISBLANK(Scheduled_Date_Time__c), now()+(1/96), IF(now()&gt;Scheduled_Date_Time__c,now()+(1/96),Scheduled_Date_Time__c+(1/96)))</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>!ISPICKVAL(SendStatus__c,&quot;Failed&quot;)         &amp;&amp;         !ISPICKVAL(SendStatus__c,&quot;Completed&quot;)         &amp;&amp;         !ISPICKVAL(SendStatus__c,&quot;Canceled&quot;)         &amp;&amp;         !ISPICKVAL(SendStatus__c,&quot;Fail&quot;)         &amp;&amp;         !ISPICKVAL(SendStatus__c,&quot;Complete&quot;)         &amp;&amp;         !ISPICKVAL(SendStatus__c,&quot;Cancel&quot;)         &amp;&amp;         !ISPICKVAL(SendStatus__c,&quot;Cancelled&quot;)      &amp;&amp;         !ISPICKVAL(SendStatus__c,&quot;Deleted&quot;)     &amp;&amp;       ! TrackingOnly__c       &amp;&amp;       ISBLANK( BackupWorkflow__c )       &amp;&amp;       (       IF       (       ISBLANK(Scheduled_Date_Time__c) ,       ( NOW()-(1/2) ) &lt;  Created_Date_Time__c ,       ( NOW()-(1/2) ) &lt;  Scheduled_Date_Time__c       )       ||       HasBeenQueued__c       ||       Split_Send__c       )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>SendClassFrom</fullName>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>(Send_Status_View__c = &apos;Fail&apos; ||  Send_Status_View__c = &apos;Failed&apos; ||  Send_Status_View__c = &apos;Error&apos; ||  Send_Status_View__c = &apos;Errored&apos; ||  Send_Status_View__c = &apos;Canceled&apos; ||  Send_Status_View__c = &apos;Deleted&apos; ||  Send_Status_View__c = &apos;Paused&apos;)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>SendStatusDateTime</fullName>
