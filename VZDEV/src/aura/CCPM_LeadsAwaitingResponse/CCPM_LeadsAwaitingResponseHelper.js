({
    loadSobjects : function(component,leadAwaitingTable) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                console.log('JSONParse1->'+JSON.stringify(objWrapperClass));
                ...
                component.set('v.lstleadsAwaitingResponseWrapper', objWrapperClass);
                leadAwaitingTable.style.visibility = "visible";
            }
        });
     ...
     paginationUsingOffset : function(component, event,offsetCalculated)
    {
        ...
        console.log('Inside helper pagination->');
        var action = component.get('c.loadComponentWithRecords');
        //Set Parameters for the Server Controller
        console.log('-------1'+component.get("v.selectedTabToSort")+''+component.get("v.orderToConsider")+''+component.get("v.sqlLimit")+''+component.get("v.offSet"));
        action.setParams({ strSortBy : component.get("v.selectedTabToSort"),strOrderby : component.get("v.orderToConsider"),strLimit : component.get("v.sqlLimit"),strOffSet :component.get("v.offSet")});
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {
                ...
                component.set('v.lstleadsAwaitingResponseWrapper', objWrapperClass);
                 console.log('lstleadsAwaitingResponseWrapper'+objWrapperClass);
            }
        });
        $A.enqueueAction(action);
